...
public class AssetCheckOut implements Parcelable {
    ...
    protected AssetCheckOut(Parcel in) {
    ...
    public static final Creator<AssetCheckOut> CREATOR = new Creator<AssetCheckOut>() {
        ...
        public AssetCheckOut createFromParcel(Parcel in) {
            return new AssetCheckOut(in);
        }
        
        @Override
        public AssetCheckOut[] newArray(int size) {
            return new AssetCheckOut[size];
        }
    };
