...
//    public void formFineModel(final Bundle arguments) {
//        if (arguments != null) {
//            setIsLoding(true);
//            PatronInfo patronInfo = arguments.getParcelable(PATRON_INFO_KEY);
//
//
//            List<Fine> checkoutItemList = new ArrayList<>();
//
//            for (:
//                 ) {
//
...
//                                .getDueDate(), false, checkouts.get(i)
//                                .getOverDue()));
//                    } else {
...
//            }
//            setIsLoding(false);
//            fineLiveData.postValue(checkoutItemList);
//        }
//    }
}
