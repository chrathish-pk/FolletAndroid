...
public class Permissions {
    ...
    @SerializedName("canCheckinAsset") @Expose private String canCheckinAsset;
    @SerializedName("canCheckinLibrary") @Expose private String canCheckinLibrary;
    @SerializedName("canCheckinTextbook") @Expose private String canCheckinTextbook;
    @SerializedName("canCheckoutAsset") @Expose private String canCheckoutAsset;
    @SerializedName("canCheckoutLibrary") @Expose private String canCheckoutLibrary;
    @SerializedName("canCheckoutTextbook") @Expose private String canCheckoutTextbook;
    @SerializedName("canDeleteHold") @Expose private String canDeleteHold;
    @SerializedName("canDoBasicSearch") @Expose private String canDoBasicSearch;
    @SerializedName("canLinkToFollettShelf") @Expose private String canLinkToFollettShelf;
    @SerializedName("canOverrideBlocksAsset") @Expose private String canOverrideBlocksAsset;
    @SerializedName("canOverrideBlocksLibrary") @Expose private String canOverrideBlocksLibrary;
    @SerializedName("canOverrideBlocksTextbook") @Expose private String canOverrideBlocksTextbook;
    @SerializedName("canPlaceHold") @Expose private String canPlaceHold;
    @SerializedName("canPlaceHoldOnAvailableCopies") @Expose private String canPlaceHoldOnAvailableCopies;
    @SerializedName("canPlaceHoldOnMultipleCopies") @Expose private String canPlaceHoldOnMultipleCopies;
    @SerializedName("canPostToSocialMediaSites") @Expose private String canPostToSocialMediaSites;
    @SerializedName("canRenew") @Expose private String canRenew;
    @SerializedName("canSearchDigitalResources") @Expose private String canSearchDigitalResources;
    @SerializedName("canSearchOneSearch") @Expose private String canSearchOneSearch;
    @SerializedName("canSearchWPE") @Expose private String canSearchWPE;
    @SerializedName("canSeeSearchSuggestions") @Expose private String canSeeSearchSuggestions;
    @SerializedName("canSubmitLibraryReviewComments") @Expose private String canSubmitLibraryReviewComments;
    @SerializedName("canSubmitLibraryReviews") @Expose private String canSubmitLibraryReviews;
    @SerializedName("canUseBookclub") @Expose private String canUseBookclub;
    @SerializedName("canUseDestinyQuest") @Expose private String canUseDestinyQuest;
    @SerializedName("canViewCheckoutHistory") @Expose private String canViewCheckoutHistory;
    @SerializedName("canViewCopyStatusAsset") @Expose private String canViewCopyStatusAsset;
    @SerializedName("canViewCopyStatusLibrary") @Expose private String canViewCopyStatusLibrary;
    @SerializedName("canViewCopyStatusTextbook") @Expose private String canViewCopyStatusTextbook;
    @SerializedName("canViewItemsOutAsset") @Expose private String canViewItemsOutAsset;
    @SerializedName("canViewItemsOutLibrary") @Expose private String canViewItemsOutLibrary;
    @SerializedName("canViewItemsOutTextbook") @Expose private String canViewItemsOutTextbook;
    @SerializedName("canViewMyInfo") @Expose private String canViewMyInfo;
    @SerializedName("canViewMyList") @Expose private String canViewMyList;
    @SerializedName("canViewNewArrivals") @Expose private String canViewNewArrivals;
    @SerializedName("canViewOffsiteInfo") @Expose private String canViewOffsiteInfo;
    @SerializedName("canViewPatronStatus") @Expose private String canViewPatronStatus;
    @SerializedName("canViewPublicLists") @Expose private String canViewPublicLists;
    @SerializedName("canViewTop10") @Expose private String canViewTop10;
